...
public class NumberZeroProvider implements DefaultValueProvider {
    /**
     ...
     */
    @Override
    public @Nullable Object provide(@NotNull Opacker.Context context, @NotNull Object object, CapturedType.@NotNull FieldProperty fieldProperty) {
        return 0;
    }
}
